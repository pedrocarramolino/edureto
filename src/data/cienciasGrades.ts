...
const grades: GradeDefinition[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { question: "¿Qué parte de la célula contiene el ADN?", options: ["la membrana", "el núcleo", "el citoplasma", "la pared celular"], correctIndex: 1, explanation: "El núcleo guarda el material genético de la célula." },
      { question: "¿Cuál es el gas más abundante en la atmósfera?", options: ["el oxígeno", "el nitrógeno", "el dióxido de carbono", "el hidrógeno"], correctIndex: 1, explanation: "El nitrógeno es casi el 78 % del aire." },
      { question: "¿Qué tipo de roca se forma por acumulación de sedimentos?", options: ["magmática", "sedimentaria", "metamórfica", "volcánica"], correctIndex: 1, explanation: "Los sedimentos se acumulan en capas y se compactan." },
      { question: "¿Qué vertebrados respiran por branquias y tienen escamas?", options: ["los anfibios", "los peces", "los reptiles", "las aves"], correctIndex: 1, explanation: "Los peces toman el oxígeno del agua con sus branquias." },
    ],
  },
  {
    id: "n3e",
    ...
    questions: [
      ...
      { question: "¿Dónde se produce el intercambio de gases en los pulmones?", options: ["en la tráquea", "en los alvéolos", "en los bronquios", "en el diafragma"], correctIndex: 1, explanation: "Los alvéolos son sacos diminutos rodeados de capilares." },
      { question: "¿Cuántas cavidades tiene el corazón humano?", options: ["2", "3", "4", "5"], correctIndex: 2, explanation: "Dos aurículas y dos ventrículos." },
      { question: "¿Qué vasos llevan la sangre desde el corazón al resto del cuerpo?", options: ["las venas", "las arterias", "los capilares", "los alvéolos"], correctIndex: 1, explanation: "Las arterias salen del corazón; las venas vuelven a él." },
      { question: "¿Qué órgano absorbe la mayor parte de los nutrientes?", options: ["el estómago", "el intestino delgado", "el intestino grueso", "el hígado"], correctIndex: 1, explanation: "Sus vellosidades multiplican la superficie de absorción." },
      { question: "¿Qué glándula regula el metabolismo con la tiroxina?", options: ["el páncreas", "la tiroides", "la hipófisis", "las suprarrenales"], correctIndex: 1, explanation: "La tiroides está en el cuello y controla el ritmo del metabolismo." },
      { question: "¿Cuál es la unidad funcional del riñón?", options: ["la neurona", "la nefrona", "el alvéolo", "el nefridio"], correctIndex: 1, explanation: "Cada riñón tiene alrededor de un millón de nefronas." },
      { question: "¿Qué células transmiten los impulsos nerviosos?", options: ["las neuronas", "los glóbulos rojos", "las plaquetas", "los osteocitos"], correctIndex: 0, explanation: "Las neuronas conducen la información por el sistema nervioso." },
      { question: "¿Qué hueso protege el encéfalo?", options: ["la columna vertebral", "el cráneo", "el esternón", "la pelvis"], correctIndex: 1, explanation: "Los huesos del cráneo forman una caja que protege el encéfalo." },
      { question: "¿Qué tipo de músculo es el corazón?", options: ["voluntario", "cardiaco e involuntario", "liso y voluntario", "esquelético"], correctIndex: 1, explanation: "El miocardio late sin que tengamos que ordenárselo." },
    ],
  },
  {
    id: "n4e",
    ...
    questions: [
      ...
      { question: "¿Qué es la meiosis?", options: ["una división que da dos células idénticas", "una división que da células con la mitad de cromosomas", "la muerte celular", "la unión de dos células"], correctIndex: 1, explanation: "La meiosis forma los gametos, con la mitad de cromosomas." },
      { question: "¿Cuántos cromosomas tiene una célula humana normal?", options: ["23", "46", "48", "92"], correctIndex: 1, explanation: "23 pares: 46 cromosomas en total." },
      { question: "¿Quién formuló las leyes de la herencia?", options: ["Darwin", "Mendel", "Lamarck", "Pasteur"], correctIndex: 1, explanation: "Gregor Mendel las dedujo experimentando con guisantes." },
      { question: "¿Qué es un alelo dominante?", options: ["el que solo se manifiesta con dos copias", "el que se manifiesta aunque haya una sola copia", "el que nunca se manifiesta", "el que está en el cromosoma Y"], correctIndex: 1, explanation: "Basta una copia para que se vea en el individuo." },
      { question: "¿Qué son los fósiles?", options: ["rocas volcánicas", "restos o señales de seres vivos del pasado conservados en las rocas", "minerales raros", "capas de la atmósfera"], correctIndex: 1, explanation: "Los fósiles nos cuentan cómo era la vida hace millones de años." },
      { question: "¿Qué energía mueve las placas tectónicas?", options: ["la energía del Sol", "el calor del interior de la Tierra", "la fuerza de la Luna", "el viento"], correctIndex: 1, explanation: "El calor interno genera corrientes en el manto que arrastran las placas." },
      { question: "¿Qué organismos son los productores de un ecosistema?", options: ["los herbívoros", "las plantas y las algas", "los hongos", "las bacterias descomponedoras"], correctIndex: 1, explanation: "Fabrican su alimento con la fotosíntesis y abren la cadena trófica." },
    ],
  },
];
